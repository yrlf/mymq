...
import com.newlandframework.mymq.consumer.ClustersState;
...
import com.newlandframework.mymq.model.RemoteChannelData;
    ...
    public Void call() throws Exception {
        for (MessageDispatchTask task : tasks) {
            ...
            if (ConsumerContext.selectByClusters(task.getClusters()) != null) {
                ...
                response.setMsgType(MessageType.MyMQMessage);
