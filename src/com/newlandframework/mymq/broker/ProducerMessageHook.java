...
import com.newlandframework.mymq.consumer.ConsumerClusters;
import com.newlandframework.mymq.consumer.ConsumerContext;
import com.newlandframework.mymq.core.AckMessageCache;
import com.newlandframework.mymq.core.AckTaskQueue;
import com.newlandframework.mymq.core.MessageTaskQueue;
import com.newlandframework.mymq.core.MessageSystemConfig;
import com.newlandframework.mymq.model.MessageDispatchTask;
...
public class ProducerMessageHook implements ProducerMessageListener {
    ...
    private boolean checkClustersSet(Message msg, String requestId) {
        if (clustersSet.size() == 0) {
            System.out.println("MyMQ don't have match clusters!");
